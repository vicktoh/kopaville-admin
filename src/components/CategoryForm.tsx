      ...
      <Formik
        ...
        validate={(values) => {
          ...
          if (!values.description) {
            errors.description = "Description for category is required";
          }
        ...
        {({
          ...
          <Form style={{ width: "100%" }}>
            ...
            <FormControl mt={3} isInvalid={!!errors.avartar}>
              ...
              />
              <FormErrorMessage>{errors.avartar || ""}</FormErrorMessage>
            </FormControl>

            <HStack>
              {file || values.avartar ? (
                <Image
                  src={(file && URL.createObjectURL(file)) || values.avartar}
                  width="80px"
                  height="80px"
                />
              ) : null}
